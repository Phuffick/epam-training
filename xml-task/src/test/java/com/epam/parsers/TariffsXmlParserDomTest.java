...
import com.epam.xml.dom.TariffsXmlParserDom;
...
public class TariffsXmlParserDomTest {

    @Test
    public void oneTariffTest() {
        TariffsXmlParserDom tariffsXmlParserDom
                = new TariffsXmlParserDom();
        List<Tariff> parsedTariffsDom = tariffsXmlParserDom.parse(
        ...
        Assert.assertEquals(expected, parsedTariffsDom.get(0));
    }
}
