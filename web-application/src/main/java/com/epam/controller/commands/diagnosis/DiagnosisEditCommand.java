...
/**
 * DiagnosisEditCommand definition class.
 *
 * @version    1.0.0 23 May 2021
 * @author     Belyack Maxim
 */
public class DiagnosisEditCommand extends Command {

    /**
     * Diagnosis edit command
     * @return direct
     */
    @Override
    public Direct execute(HttpServletRequest req,
        ...
        if (id != null) {
            try {
                DiagnosisService surgeryService
                        = getServiceFactory().getDiagnosisService();
                Diagnosis diagnosis = surgeryService.findById(id);
